...
export async function GET() {
  ...
  try {
    try {
      await checkPublicSchemaHealth()
      result.public = true
    } catch (e) {
      console.warn('[health GET] 공용 스키마 오프라인:', e)
    }

    try {
      await checkAdminSchemaHealth()
      result.admin = true
    } catch (e) {
      console.warn('[health GET] 어드민 스키마 오프라인:', e)
    }
...
export async function POST() {
  ...
  try {
    try {
      ...
      console.warn('[health POST] 공용 스키마 오프라인:', e)
    }
    ...
    try {
      ...
      console.warn('[health POST] 어드민 스키마 오프라인:', e)
    }
